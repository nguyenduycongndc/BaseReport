...
function fnSearchSuccess(rspn) {
    ...
    if (rspn !== undefined && rspn !== null) {
        ...
        for (var i = 0; i < rspn.data.length; i++) {
            ...
            var TTG = (obj.lastlogout != null ? ((((Hourslastlogout <= 11) && (Minuteslastlogout < 30)) || ((Hoursfirstlogin >= 13) && (Minutesfirstlogin > 0))) ? (Math.abs(Hourslastlogout - Hoursfirstlogin) + "giờ" + Math.abs(Minuteslastlogout - Minutesfirstlogin) + "phút") : (Math.abs(Hourslastlogout - Hoursfirstlogin) >= 8 && Math.abs(Minuteslastlogout - Minutesfirstlogin) > 0 ? "8 giờ" : (Math.abs(Hourslastlogout - Hoursfirstlogin - 1) + "giờ" + Math.abs(Minuteslastlogout - Minutesfirstlogin - 30) + "phút"))) : "")
            var html = '<tr>' +
                ...
                '<td>' + TTG/*(obj.lastlogout != null ? ((((Hourslastlogout <= 11) && (Minuteslastlogout < 30)) || ((Hoursfirstlogin >= 13) && (Minutesfirstlogin > 0))) ? (Math.abs(Hourslastlogout - Hoursfirstlogin) + "giờ" + Math.abs(Minuteslastlogout - Minutesfirstlogin) + "phút") : ((Hourslastlogout - Hoursfirstlogin) == 8 && (Minuteslastlogout - Minutesfirstlogin) > 0 ? "8 giờ" : (Math.abs(Hourslastlogout - Hoursfirstlogin - 1) + "giờ" + Math.abs(Minuteslastlogout - Minutesfirstlogin - 30) + "phút"))) : "")*/ + '</td>' +
                '<td>' + ((Hoursfirstlogin >= 10) ? "Vắng buổi sáng" : ((Hourslastlogout <= 15) ? "Vắng buổi chiều" : "")) + '</td>' +
                '<td>' + (obj.lastlogout != null && Math.abs(Hourslastlogout - Hoursfirstlogin) < 8 ? ((((Hourslastlogout <= 11) && (Minuteslastlogout < 30)) || ((Hoursfirstlogin >= 13) && (Minutesfirstlogin > 0))) ? (8 - Math.abs(Hourslastlogout - Hoursfirstlogin) + "giờ" + (Math.abs(Minuteslastlogout - Minutesfirstlogin) != 0 ? (60 - Math.abs(Minuteslastlogout - Minutesfirstlogin)) : Math.abs(Minuteslastlogout - Minutesfirstlogin)) + "phút") : (Math.abs(Hourslastlogout - Hoursfirstlogin) >= 8 && Math.abs(Minuteslastlogout - Minutesfirstlogin) > 0 ? "8 giờ" : (8 - Math.abs(Hourslastlogout - Hoursfirstlogin - 1) + "giờ" + (Math.abs(Minuteslastlogout - Minutesfirstlogin - 30) != 0 ? (60 - Math.abs(Minuteslastlogout - Minutesfirstlogin - 30)) : Math.abs(Minuteslastlogout - Minutesfirstlogin - 30)) + "phút"))) : "") + '</td>' +
